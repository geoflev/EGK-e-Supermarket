...
<html>
    ...
    <body>
        ...
        <div class="generic-container">
            ...
            <br>
            <form:form  id="form" method="POST" action="new" modelAttribute="product" class="form-horizontal">
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <form:input id="quantity" type="text" path="quantity" class="form-control input-sm" maxlength="15" required="required"/>
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <form:input id="price" type="text" path="price" class="form-control input-sm" maxlength="10" required="required"/>
